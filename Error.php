...
<head>
    ...
    <title>Cliply</title>
    <link rel = "icon" href = "https://clippsly.org/wp-content/uploads/2022/02/clippsly-image-small1.png" type = "image/x-icon">
            ...
            <div class="center-screen">
                <div class="col-lg-8">
                    <div class="main-box">
                        ...
                        <a href="index.php" class="btn btn-lg btn-danger">GO BACK</a>
                    </div>  
                </div>
            </div>
        </div>
